...
public class F4ConsultarVentas extends javax.swing.JFrame {
    ...
    public F4ConsultarVentas(JSONArray jsonClientes, JSONArray jsonVehiculos, JSONArray jsonUsuarios, JSONArray jsonVentas) {
        initComponents();
        control = new VentaControladora(this);
        control.iniciaVentana(this,  "src/imagenes/diamante.png");  
       ...
       this.model = control.llenarTablaPrincipal(jsonVentas); 
...
//        miTablaVentas.setEnabled(false);
    ...
    private void initComponents() {
        ...
        Bienvenida.setText("Consultar Ventas: ");
        getContentPane().add(Bienvenida, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 400, 100));
    ...
    private void miTablaVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miTablaVentasMouseClicked
        ...
        String IdVenta = String.valueOf(miTablaVentas.getValueAt(seleccionar, 0)); 
        //CREA LA VENTA SELECCIONADA
        Venta ventaSeleccionada = control.crearVentaDelJson(jsonVentas, IdVenta); 
        //CREA EL CLIENTE Y EL VEHICULO SELECCIONADO
        String cedula0 = String.valueOf(ventaSeleccionada.getCedulaComprador()); 
        Cliente clienteDeVenta = controladoraClientes.crearClienteDelJson(jsonClientes, cedula0); 
        Vehiculo vehiculoDeVenta = controladoraVehiculos.crearVehiculoDelJson(jsonVehiculos, ventaSeleccionada.getPlaca()); 
        //ABRIMOS LA PESTANA PARA VER LOS DATOS COMPLETOS
        MostrarSeleccionadoVentas adelante = new MostrarSeleccionadoVentas(jsonClientes,jsonVehiculos,jsonUsuarios,jsonVentas, ventaSeleccionada, clienteDeVenta, vehiculoDeVenta, this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F4ConsultarVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F4ConsultarVentas().setVisible(true);
            }
        });
    }
