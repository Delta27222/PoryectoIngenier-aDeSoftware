...
public class EG3DesHacerVenta extends javax.swing.JFrame {
   ...
   VentaControladora control; 
    ...
    public EG3DesHacerVenta(JSONArray jsonClientes, JSONArray jsonVehiculos, JSONArray jsonUsuarios, JSONArray jsonVentas) {
        initComponents();
        control = new VentaControladora(this);
        control.iniciaVentana(this,  "src/imagenes/diamante.png");  
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 120, 130));
        ...
        Bienvenida.setText("Venta a Deshacer:");
        ...
        btnAgregarS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btEliminar58px.png"))); // NOI18N
        ...
        btnAgregarS.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btEliminar72px.png"))); // NOI18N
        btnAgregarS.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btEliminar72px.png"))); // NOI18N
    ...
    private void btnAgregarSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarSActionPerformed
        ...
        if(!txtMonto.getText().equals("") && !txtMontoAbonado.getText().equals("") && !txtPlaca.getText().equals("")  && !txtCedula.getText().equals("")  && !txtUserName.getText().equals("")){
            jsonVentas = control.eliminarVentaDelJson(jsonVentas, txtIDVenta.getText()); 
            JOptionPane.showMessageDialog(null, "Se ha deshecho la venta del sistema con exito."); 
            ...
            JOptionPane.showMessageDialog(null, "Sucedio un problema intente de nuevo.");
            jPanel2.setVisible(false);
            btnACEPTAR.setVisible(true);
            txtIDVenta.setText("");
            txtMonto.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EG3DesHacerVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EG3DesHacerVenta().setVisible(true);
            }
        });
    }
