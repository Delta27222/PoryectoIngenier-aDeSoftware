...
public class B0GestionarCliente extends javax.swing.JFrame {
    ...
    public B0GestionarCliente(JSONArray jsonClientes, JSONArray jsonVehiculos, JSONArray jsonUsuarios, JSONArray jsonVentas) {
        initComponents();
        control = new ClienteControladora(this);
        control.iniciaVentana(this,  "src/imagenes/diamante.png");  
    ...
    private void initComponents() {
        ...
        Bienvenida.setText("Gestionar Cliente:");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
         if (control.hayAlguien(jsonClientes)){
            BG2ModificarCliente atras = new BG2ModificarCliente(jsonClientes,jsonVehiculos, jsonUsuarios,jsonVentas);
            atras.setVisible(true);
            this.dispose();
         }else{
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
         if (control.hayAlguien(jsonClientes)){
            BG3EliminarCliente atras = new BG3EliminarCliente(jsonClientes,jsonVehiculos, jsonUsuarios,jsonVentas);
            atras.setVisible(true);
            this.dispose();
         }else{
             JOptionPane.showMessageDialog(null, "No hay clientes en el sistema.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(B0GestionarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new B0GestionarCliente().setVisible(true);
            }
        });
    }
